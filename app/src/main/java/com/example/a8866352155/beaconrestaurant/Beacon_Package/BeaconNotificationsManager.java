package com.example.a8866352155.beaconrestaurant.Beacon_Package;
...
import com.example.a8866352155.beaconrestaurant.IntroActivity;
...
public class BeaconNotificationsManager {
    ...
    private void showNotification(String message) {
        Intent resultIntent = new Intent(context, IntroActivity.class);
